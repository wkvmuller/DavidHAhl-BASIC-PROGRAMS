...
210 I$=“ "+I$+"	"
220 REM 
230 FOR L=1 TO LEN (It)
240 IF MID$(I$,L, 1)="'" THEN I$t=LEFT$ (i$, L-l) +RIGHT$ (i$. LEN (I$)-L) : GOTO 240
250 IF L+4 <= LEN(It) THEN IF MID$(I$,L,4)="SHUT" THEN PRINT "Shut up...":END
260 NEXT L
...
410 K~36:G0T0 630
420 REM
430 REM TAKE RIGHT PAR$ OF S$RING 440 REM AND CONJUGATE CORREC$LY 450 REM
...
570 IF MlDt(C$,L,LEN(R$))<>R$ THEN 600
580 C$=LEFT$(C$,L-1)+S$+RIGHT$(C$,LEN(C$)-L-LEN(R$)+!)
590 l=l+LEN(S$)
600 next l
610 next x
620 rem
...
1310 REM --- REPLIES ---
1320 REM
1330 DATA "DON’T YOU BELIEVE THAT CAN*"
...
1570 DATA "HOW DO YOU KNOW 1 CAN’T*"
...
2050 DATA "WHY NO?" "WHY ARE YOU CONCERNED ABOUT MY*"
2060 DATA "WHAT ABOUT YOUR OWN*"
2070 DATA  "CAN YOU THINK OF A SECIFIC EXAMPLE?"
2080 DATA  “WHEN?"
2090 DATA  "WHAT ARE YOU THINKING OF?"
2100 DATA  "REALLY, ALWAYS?" "DO YOU REALLY THINK SO"
2110 DATA  "BUT YOU ARE NOT SURE YOU*"
2110 DATA  "DO YOU DOUBT YOU*"
2120 DATA  "IN WHAT WAY?"
2130 DATA  "WHAT RESEMBLENCE DO YOU SEE?"
2140 DATA "WHAT DOES THE SIMILARITY SUGGEST TO YOU'"' 
2150 DATA "WHAT OTHER CONNECTIONS DO YOU SEE?"
2160 DATA  "COULD THERE REALLY BE SOME CONNECTION'"
2170 DATA  "HOW?"
2180 DATA "YOU SEEM QUITE POSITIVE."
2190 DATA  "ARE YOU SURE?" 
2200 DATA  "I SEE."
2210 DATA "I UNDERSTAND."
2220 DATA "WHY DO YOU BRING UP THE TOPIC OF FRIENDS?"
2230 DATA "DO YOUR FRIENDS WORRU YOU?"
2240 DATA "DO YOUR FRIENDS PICK ON YOU?"
2250 DATA "ARE YOU SURE YOU HAVE ANY FRIENDS?"
2260 DATA "DO YOU IMPOSE ON YOUR FRIENDS?"
2270 DATA "PERHAPS YOUR LOVE FOR FRIENDS WORRIES YOU?"
2280 DATA  "DO COMPUTERS WORRY YOU?"
2290 DATA "ARE YOU TALKING ABOUT ME IN PARTICULAR?"
2300 DATA "ARE YOU FRIGHTENED BY MACHINES?"
2310 DATA "WHY DO YOU MENTION COMPUTERS?"
2320 DATA "WHAT DO YOU THINK COMPUTER HAVE TO DO WITH YOUR PROBLEM?"
2330 DATA "DON’T YOU THINK COMPUTERS CAN HELP PEOPLE?"
2340 DATA "WHAT IS IT ABOUT MACHINES THAT WORRIES YOU?"
2350 DATA "SAY, DO YOU HAVE ANY PSYCOLOGICAL PROBLEMS?"
2360 DATA "WHAT DOES THAT SUGGEST TO YOU?" DATA "I SEE."
2370 DATA "I’M NOT SURE I UNDERSTAND YOU FULLY."
2380 DATA "COME COME ELUCIDATE YOUR THOUGHTS."
2390 DATA "CAN YOU ELABORATE ON THAT?"
2400 DATA "THAT IS QUITE INTERESTING." 
2500 REM
2510  REM REM --- REPLY FINDING DATA ----
2520 REM
